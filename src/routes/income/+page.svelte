<script lang="ts">
	...
	function createStageOneCannonMinion() {
		return createCannonMinion(
			Time.minutes(2).seconds(5),
			Time.minutes(15).seconds(5),
	...
	const Minions = [
		MeleeMinion,
		RangedMinion,
		StageOneCannonMinion,
		StageTwoCannonMinion,
		StageThreeCannonMinion
	];
